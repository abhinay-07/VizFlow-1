...
const navigation = [
  ...
  { name: "Merge Data", href: "/merge", icon: GitMerge },
...
export default function Layout({ children }) {
  ...
  return (
    <div className="h-screen bg-gray-50 flex flex-row">
      ...
      <aside
        className={cn(
          "z-50 w-64 bg-white shadow-lg transform transition-transform duration-300 ease-in-out h-screen flex-shrink-0 fixed lg:static top-0 left-0 overflow-y-auto",
          sidebarOpen
            ? "inset-y-0 translate-x-0"
            : "inset-y-0 -translate-x-full lg:translate-x-0"
        )}
      >
